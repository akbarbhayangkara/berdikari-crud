		...
		<div class="col-md-12">
			<?php echo form_open('pelanggan/update') ?>
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="alamat_pelanggan" value="<?php echo $data_pelanggan->alamat_pelanggan ?>" class="form-control" placeholder="Masukkan Alamat pelanggan">
			  </div>

			  <div class="form-group">
			    <label for="text">Telepon</label>
			    <input type="text" name="telepon" value="<?php echo $data_pelanggan->telepon ?>" class="form-control" >
			  </div>

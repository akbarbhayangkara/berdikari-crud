...
<div class="container" style="margin-top: 80px">
	<div class="row">
		...
		<a href="<?php echo base_url() ?>pelanggan/tambah/" class="btn btn-md btn-success">Tambah Pelanggan</a>
		<hr>
		<!-- table -->
			...
			<table id="table" class="table table-striped table-bordered table-hover">
			    ...
			    ?>
			      ...
			      <tr>
			        ...
			        <td>
			        	<a href="<?php echo base_url() ?>pelanggan/edit/<?php echo $hasil->id_pelanggan ?>" class="btn btn-sm btn-success">Edit</a>
			        	<a href="<?php echo base_url() ?>pelanggan/hapus/<?php echo $hasil->id_pelanggan ?>" class="btn btn-sm btn-danger">Hapus</a>
			        </td>
			      </tr>
